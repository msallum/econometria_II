...
D Monte a matriz de variância e covariância deste modelo. ˆ
...
resíduos utilizando método matricial. ´
C Calcule o R^2^ deste modelo.
D Monte a matriz de variância e covariância robusta deste modelo. ˆ
E Verifique se os $\beta_{1},\ \beta_{2},\ \beta_{3}$ sao significantes ao nível de 5% de significância.
...
11. Ainda pensando em RDDs, explique o conceito de ”bandwidth”. Como o uso de uma largura de banda maior afeta sua estimativa dos efeitos do tratamento?
